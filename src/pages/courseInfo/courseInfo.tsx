        ...
        <div className="mx-auto w-full max-w-6xl custom-scrollbar">
            <div className="w-full">
                <div className="flex items-center">
                    ...
                    <LuDot />
                    <p className="ml-1 font-bold text-blue-500 line-clamp-1">Nuxt JS</p>
                </div>
            </div>
            <div className="mt-6 flex flex-row gap-10 rounded-md bg-secondary p-4 lg:p-8">
                <div className="w-full lg:w-[60%]">
                    ...
                    <h1 className="mt-4 lg:mt-0 font-medium text-3xl">Nuxt JS</h1>
                    <p className="w-full opacity-50 text-[15px] mt-3">
                        NuxtJS to'liq kurs o'zbek tilida, xozirgi kunda eng ommabob frameworklardan biri xisoblangan ushbu texnologiyani o'rganing. NuxtJS amaliy loyiha o'zbek tilida
                    </p>
